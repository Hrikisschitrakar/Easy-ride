...
<body>
    ...
    */
        ...
        if (isset($_POST['AddBooking'])) {
            ...
            $tel = $_POST['tel'];
            $email = $_POST['email'];
            $board_place = $_POST['boarding_place'];
                ...
                <form action="#" method="POST">
                    <div class="form_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="tel" value="<?php echo $user_data['telephone']; ?>"
                                 required>
                        </div>
                        ...
                        <div class="input_wrap">
                            <label for="via_city">Select Board Destination</label>
                            <select id="via_city" name="boarding_place" class="idclass" required>
                                <?php 
