...
if(isset($_POST['routeAdd'])){
    ...
    if($check_result->num_rows > 0) {
        ...
        echo '<script>alert("ID already exists. Please choose another ID."); window.location.href="StationManagerAddroute.php";</script>';
    } else {
        ...
        if($via_city == $destination) {
            ...
            echo '<script>alert("Via city and destination cannot be the same. Please choose different locations."); window.location.href="StationManagerAddroute.php";</script>';
        } else {
            ...
            if($check_bus_result->num_rows > 0) {
                ...
                echo '<script>alert("This bus is already booked for the selected date. Please choose another date."); window.location.href="StationManagerAddroute.php";</script>';
            } else {
                ...
                if($stmt->execute()) {
                    echo '<script>alert("Successfully added route"); window.location.href="StationManager_dashboard.php";</script>';
                } else {
                    echo '<script>alert("Failed to add bus. Please try again."); window.location.href="StationManagerAddroute.php";</script>';
                }
