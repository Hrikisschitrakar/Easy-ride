            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="flex">
                        ...
                        <div class="inputBox">
                            <span>zip code :</span>
                            <input type="text" placeholder="44600" name="zip">
                        </div>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="inputBox">
                        ...
                        <input type="text" placeholder="your full name" name="cardName" required>
                    </div>
                    <div class="inputBox">
                        <span>credit card number :</span>
                        <input type="number" placeholder="1111" name="cardNumber" required>
                    </div>
                    <div class="inputBox">
                        <span>exp month :</span>
                    ...
                    <div class="flex">
                        <div class="inputBox">
                            <span>exp year :</span>
                            <input type="number" placeholder="2026" name="expYear" required>
                        </div>
                        <div class="inputBox">
                            <span>CVV :</span>
