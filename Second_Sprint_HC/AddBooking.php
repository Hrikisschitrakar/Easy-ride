                ...
                <form action="#" method="POST">
                    <div class="form_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="passenger_name"
                                value="<?php echo $user_data['First_Name']; ?>" readonly required>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="email" value="<?php echo $user_data['email']; ?>"
                                readonly required>
                        </div>
                        <div class="input_wrap">
                            <label for="title">Pickup Destination</label>
                            <input type="text" id="title" name="board_place" placeholder="Boarding Place" required>
                        </div>
                        <div class="input_wrap">
                            <label for="title">Your destination</label>
                            <input type="text" id="title" name="Your_destination" placeholder="Destination" required>
                        </div>
                    </div>
