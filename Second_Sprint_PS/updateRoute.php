...
<body>
    ...
    if(isset($_POST['routeUpdate'])){
        ...
        if($via_city == $destination) {
            ...
            echo '<script>alert("Via city and destination cannot be the same. Please choose different locations."); window.location.href="updateRoute.php";</script>';
        } else {
            ...
            if($check_bus_result->num_rows > 0) {
                ...
                echo '<script>alert("This bus is already booked for the selected date. Please choose another date."); window.location.href="updateRoute.php";</script>';
            } else {
